...
def parse_args():
    ...
    if args.ntry <= 0:
        ...
        parser.print_help()
        sys.exit(1)
    return ( (sorted(args.n_elems), args.graphic, args.ntry) )
...
def resultados_algoritmos(n_elems, algs, n_pruebas):
    """
...
if __name__ == "__main__":
    (n_elems, g, n_pruebas) = parse_args()
    algoritmos = cargar_algoritmos_de_modulos()
    rs = resultados_algoritmos(n_elems, algoritmos, n_pruebas)
